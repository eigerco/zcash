...
bool CWallet::FundTransaction(CMutableTransaction& tx, CAmount &nFeeRet, int& nChangePosRet, std::string& strFailReason, bool includeWatching)
{
    ...
    if (!CreateTransaction(vecSend, wtx, reservekey, nFeeRet, tx.nZsfDepositAmount, nChangePosRet, strFailReason, &coinControl, false))
        return false;
...
bool CWallet::CreateTransaction(
    ...
    bool sign)
{
    CAmount nValue { nZsfDepositAmount };
