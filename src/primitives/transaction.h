...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        if (isZip225V5) {
            ...
            READWRITE(*const_cast<CAmount*>(&nZsfDepositAmount));
        } else {
    ...
    // Return sum of txouts, (negative valueBalanceSapling or zero), JoinSplit vpub_old, and ZSF deposit.
